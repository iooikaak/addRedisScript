...
import (
	"addRedisScript/cache"
	"addRedisScript/engine"
	"flag"
	"log"
	"os"
	"time"
...
var (
	flagSet            = flag.NewFlagSet("addRedisScript", flag.ExitOnError)
	readRedisHost      = flagSet.String("readRedisHost", "127.0.0.1:6379", "read redis host address，default 127.0.0.1:6379")
	readRedisPassword  = flagSet.String("readRedisPassword", "", "read redis host password,default null")
	writeRedisHost     = flagSet.String("writeRedisHost", "127.0.0.1:6379", "write redis host address，default 127.0.0.1:6379")
